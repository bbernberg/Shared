...
//    [[[UIImage imageNamed:@"Kal.bundle/kal_tile_today_selected.png"] stretchableImageWithLeftCapWidth:6 topCapHeight:0] drawInRect:CGRectMake(0, -1, kTileSize.width+1, kTileSize.height+1)];
      CGContextSetFillColorWithColor(ctx, [UIColor colorWithRed:0.0/255.0 green:51.0/255.0 blue:102.0/255.0 alpha:1.0].CGColor);
      CGContextFillRect(ctx, CGRectMake(0, -1, kTileSize.width+1, kTileSize.height+1));
...
//    [[[UIImage imageNamed:@"Kal.bundle/kal_tile_today.png"] stretchableImageWithLeftCapWidth:6 topCapHeight:0] drawInRect:CGRectMake(0, -1, kTileSize.width+1, kTileSize.height+1)];
      textColor = [UIColor colorWithRed:(153.0/255.0)
                                  green:0.0
                                   blue:0.0
                                  alpha:1.0];
//    shadowColor = [UIColor blackColor];
...
//    CGContextShowTextAtPoint(ctx, textX, textY, day, n >= 10 ? 2 : 1);
      CTFontRef fontRef = CTFontCreateWithName((CFStringRef)@"Helvetica-Bold",
                                               [font pointSize], NULL);
      NSDictionary* attrs = @{(NSString *)kCTFontAttributeName : (id)fontRef,
                              (NSString *)kCTForegroundColorAttributeName : (id)shadowColor.CGColor};
      
      NSAttributedString *attrString = [[[NSAttributedString alloc] initWithString:dayText
                                                                        attributes:attrs
                                         ] autorelease];
      
      CTFramesetterRef framesetter = CTFramesetterCreateWithAttributedString((CFAttributedStringRef)attrString);
      CGPathRef path = CGPathCreateWithRect(CGRectMake(textX, textY, textSize.width, textSize.height), NULL);
